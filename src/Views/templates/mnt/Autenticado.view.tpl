            ...
            <section class="container-m">
                    ...
                    <form action="index.php?page=mnt-Autenticados-Autenticado&mode={{mode}}&usercod={{usercod}}" method="post">

                    <form action="index.php?page=mnt-Autenticados-Autenticado&mode={{mode}}&invPrdId={{invPrdId}}" method="post">
            ...
            <script>
                ...
                document.getElementById("btnCancelar").addEventListener("click", (e)=>{
                    e.preventDefault();
                    e.stopPropagation();
                    location.assign("index.php?page=mnt.Autenticados.Autenticados")
                })
                });
            </script>